...
// Ajouter un événement de clic pour les boutons "Ajouter au panier"
document.addEventListener('click', function(event) {
    if (event.target.closest('.add-to-cart')) {
        const produitId = event.target.closest('.add-to-cart').getAttribute('data-id'); 
        ajouterAuPanier(produitId); // Ajouter le produit au panier
    }
});
