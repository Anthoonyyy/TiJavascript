            ...
            <div class="col-lg-6 col-md-12 d-flex flex-column justify-content-start text-start" style="padding-left: 30px;"> 
                <div class="card-body ms-5">
                    ...
                    <p class="card-text mb-4 descriptionProduits">${produit.description}</p>
                     <p class="card-text mb-2 "><strong>Prix : </strong>${produit.prix}€</p>
                    <p class="card-text mb-5 quantiteDispo"><strong>Quantité disponible :</strong> ${produit.quantite}</p>
                    <button class="cartBtn  add-to-cart" data-id="${produit.id}">
